...
function Feed() {
    return (
        <div>
            <section className="form__container start">
                <div className="form__header">
                    <h1>Sign up for my newsletter!</h1>
                </div>
                <form className="full" style={{display: 'flex', flexDirection: 'column'}}>
                    <label>Email</label>
                    <input className="full" style={{maxWidth: '100%'}} />
                    <button style={{maxWidth: '100%'}}>Submit</button>
                </form>
            </section>
            <section>
                <h1>Recent News</h1>
                <div className="main-content__header">
                    <h2>Assault on Iowan’s Health Care BWK’s comments on the floor for 4/27/2019</h2>
                </div>
                <div className="main-content__body">
                    <p>Ladies and Gentlemen of the House.</p>

                    <p>Today is a sad day for the people of Iowa. What happened to working together this legislative session? Rep. Lundgren, you told me you wanted to work with Democrats and stay away from divisive issues. This is the exact opposite. This legislation is NOT something the people of Iowa want to see coming out of the Statehouse.</p>

                    <p>We have done nothing to fix the Medicaid disaster. Nothing! We are doing nothing to hold our MCOs accountable for the crisis privatization has caused. Just last month, we lost Iowa’s largest MCO and instead of addressing the 400,000 people displaced, we are attacking one of our most marginalized populations. If you want to make privatized health care work, you need to be correcting, and holding Iowa’s MCOs to the highest standard possible – not excusing them for their greed, allowing them to reduce, deny and terminate services for their members. We are letting some of Iowa’s most vulnerable people slip through the systems fingers – the havoc that’s been caused is this body’s responsibility and it’s humiliating and quite frankly, shameful. If there is a place to address the privatized Medicaid mess, this would be the bill to do it.</p>

                    <p>Not only does this bill turn a blind eye to Medicaid, but it addresses topics not near HHS Budget! This amendment takes away the civil rights of Iowa’s transgender population. You didn’t even give the citizens who are affected by this bill a chance to give their opinion. This proposal deserved to be thoroughly examined and it was not!. This amendment is mean spirited and cruel. What are you thinking!!??</p>

                    <p>It can be hard to understand what it’s like to be transgender, especially if you’ve never met a transgender person. A transgender person transitions to live every day as the gender they’ve always known themselves to be.</p>

                    <p>These are people. Ronan grew up in my district in old town Ames. Their home was known for its an outdoor pool in the back. My son has many stories hanging out at that pool. Ronan’s mom made the cake for my son’s graduation party. Ronan comes from a warm, loving and hard working family.</p>

                    <p>Ronan was an undergraduate when he came out his and and his mom said “Oh honey, I know” Ronan’s mom was waiting for Ronan to come out but she knew he needed to do it on his own time. Ronan said his parents didn’t have all the answers but they worked to be supportive and always loved Ronan.</p>

                    <p>I have fond memories of great conversations with both of Ronan’s parents. I knew that when my son was at their house he was in a safe place.</p>

                    <p> Talking to Ronan, he said “I was glad to be raised in Iowa. But hearing about this amendment, Iowans need to have some tough conversations. “</p>

                    <p>Ronan is a person who deserves equal protection under our laws.</p>
                    <p>
